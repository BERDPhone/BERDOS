...
int main() {
	...
	int signal_task = create_process(&signal_driver_status);
	int hello_world_task = create_process(&hello_world);
	int hello_world_task2 = create_process(&hello_world);
	int hello_world_task3 = create_process(&hello_world);
